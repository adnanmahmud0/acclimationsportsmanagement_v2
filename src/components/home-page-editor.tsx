...
export function HomePageEditor() {
  ...
  const updateContent = (section: keyof PageData["content"], field: string, value: unknown) => {
    setData((prev: PageData | null) => {
      ...
      return {
        ...prev,
        content: { ...prev.content, [section]: { ...prev.content[section], [field]: value } }
      }
    })
  }
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="max-w-md bg-[#18191a] rounded-xl overflow-hidden border border-white/10 shadow-2xl font-sans">
                <div className="relative aspect-[1.91/1] bg-[#242526] flex items-center justify-center overflow-hidden p-6">
                  {data.seo.ogImage ? (
                    ...
                    <div className="relative w-full h-full flex items-center justify-center bg-white/5">
                      <Image src="/logo/AcclimationLogo-Vartical.png" alt="Logo" width={120} height={120} className="object-contain opacity-50" />
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-4 pt-4 border-t border-white/5">
                  ...
                  <div className="bg-white/5 p-4 rounded-2xl space-y-4 border border-white/5">
                    <EditField label="Chart Title" value={data.content.hero.chart.title} onChange={(v) => {
                      const newChart = { ...data.content.hero.chart, title: v }
                        ...
                        <div key={idx} className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              updateContent("hero", "chart", { ...data.content.hero.chart, data: newData })
                            }}
